...
def getFPV_data():
    ...
    while  True:       
        ...
        dataQ.put((t,id,act,az,el,yaw,roll,roll,north,east,down))
...
def updatePlots():
    ...
    try:
        t, id, act, az,el, yaw,roll, roll, north, east, down = dataQ.get_nowait()
    #print('north:', north)
    except queue.Empty:
...
# UPDATE button 
plotButton = tk.Button(frame2, text = 'PLOT', bg ='gray', fg= 'black', padx=5, pady=5, command=updatePlots) #lambda: [updatePlots()]) 
