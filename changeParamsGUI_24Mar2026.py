...
def logData(end_timer):
    ...
    fieldnames = ['node_id','time_utc_usec', 'active_intensity', 'azimuth', 'elevation', 'heading', 'pitch', 'north', 'east', 'down']
...
timerEntry.grid(row=1, column=1, padx=5, pady=5) #pack(side = 'right', padx=5, pady=5)
