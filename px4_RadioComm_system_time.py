...
def getFPV_data1():
    ...
    while True:            
        ...
        if msg1: 
            ...
            t1 = msg1.timestamp #_sample time_utc_usec
...
def getFPV_data2():
    ...
    while True: 
        ...
        if msg2:
            ...
            t2 = msg2.timestamp #timestamp #timestamp_sample
            act2= msg2.active_intensity 

        dataQ2.put((t2,act2)) #mel2


# msg1 = the_connection2.recv_match(type='SENSOR_AVS_LITE',blocking=True)
# print(f"time_utc_usec: {msg1.time_utc_usec}")  # Should be ~1736272000000000 (2025)
# print(f"timestamp:     {msg1.timestamp}")      # Time since boot (smaller number)
